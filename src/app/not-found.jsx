  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-5 relative z-[1] gap-7">
      ...
      <div className="flex gap-8 z-[1]">
        <Link
          href="/"
          className="inline-flex items-center gap-[0.7em] px-[38px] py-[18px] border-none rounded-[14px] bg-[linear-gradient(90deg,#011c40,#26658c)] text-white text-[1.15rem] font-bold tracking-[0.5px] shadow-[0_4px_16px_rgba(0,112,243,0.15)] cursor-pointer transition-[background,transform,box-shadow] duration-300 outline-none no-underline mx-3 hover:bg-[#09437d] hover:shadow-[0_6px_24px_rgba(0,112,243,0.18)] hover:-translate-y-0.5 hover:scale-[1.04] active:scale-[0.97] active:shadow-[0_2px_8px_rgba(0,112,243,0.10)]"
        >
          🌐 Voltar à Home
        </Link>
        <Link
